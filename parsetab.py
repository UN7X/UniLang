...
_lr_productions = [
  ...
  ('program -> statement_list','program',1,'p_program','interpreter.py',353),
  ('program -> statement_list NEWLINE','program',2,'p_program','interpreter.py',354),
  ('statement_list -> statement_list NEWLINE statement','statement_list',3,'p_statement_list','interpreter.py',362),
  ('statement_list -> statement','statement_list',1,'p_statement_list','interpreter.py',363),
  ('statement -> assignment','statement',1,'p_statement','interpreter.py',371),
  ('statement -> print_statement','statement',1,'p_statement','interpreter.py',372),
  ('statement -> if_statement','statement',1,'p_statement','interpreter.py',373),
  ('statement -> while_statement','statement',1,'p_statement','interpreter.py',374),
  ('statement -> function_def','statement',1,'p_statement','interpreter.py',375),
  ('statement -> for_loop','statement',1,'p_statement','interpreter.py',376),
  ('statement -> return_statement','statement',1,'p_statement','interpreter.py',377),
  ('statement -> wait_statement','statement',1,'p_statement','interpreter.py',378),
  ('statement -> block','statement',1,'p_statement','interpreter.py',379),
  ('statement -> expression_statement','statement',1,'p_statement','interpreter.py',380),
  ('expression_statement -> expression','expression_statement',1,'p_expression_statement','interpreter.py',385),
  ('expression -> expression INCREMENT','expression',2,'p_expression_increment','interpreter.py',389),
  ('expression -> expression DECREMENT','expression',2,'p_expression_increment','interpreter.py',390),
  ('expression -> IDENTIFIER PLUS_EQUALS expression','expression',3,'p_expression_compound_assignment','interpreter.py',398),
  ('expression -> IDENTIFIER MINUS_EQUALS expression','expression',3,'p_expression_compound_assignment','interpreter.py',399),
  ('assignment -> IDENTIFIER EQUALS expression','assignment',3,'p_assignment','interpreter.py',408),
  ('print_statement -> PRINT LPAREN expression RPAREN','print_statement',4,'p_print_statement','interpreter.py',412),
  ('if_statement -> IF expression block','if_statement',3,'p_if_statement','interpreter.py',417),
  ('if_statement -> IF expression block ELSE block','if_statement',5,'p_if_statement','interpreter.py',418),
  ('for_loop -> FOR IDENTIFIER IN iterable block','for_loop',5,'p_for_loop','interpreter.py',426),
  ('iterable -> expression','iterable',1,'p_iterable','interpreter.py',430),
  ('iterable -> RANGE LPAREN expression COMMA expression RPAREN','iterable',6,'p_iterable','interpreter.py',431),
  ('while_statement -> WHILE expression block','while_statement',3,'p_while_statement','interpreter.py',441),
  ('function_def -> DEFINE IDENTIFIER LPAREN RPAREN block','function_def',5,'p_function_def','interpreter.py',445),
  ('function_def -> DEFINE IDENTIFIER LPAREN param_list RPAREN block','function_def',6,'p_function_def','interpreter.py',446),
  ('param_list -> IDENTIFIER','param_list',1,'p_param_list','interpreter.py',454),
  ('param_list -> param_list COMMA IDENTIFIER','param_list',3,'p_param_list','interpreter.py',455),
  ('param_list -> empty','param_list',1,'p_param_list','interpreter.py',456),
  ('statement -> IMPORT IDENTIFIER','statement',2,'p_import_statement','interpreter.py',466),
  ('return_statement -> RESULT expression','return_statement',2,'p_return_statement','interpreter.py',470),
  ('expression -> equality_expr','expression',1,'p_expression','interpreter.py',474),
  ('fstring -> F_QUOTE fstring_content QUOTE','fstring',3,'p_fstring','interpreter.py',478),
  ('fstring_content -> fstring_content fstring_part','fstring_content',2,'p_fstring_content','interpreter.py',482),
  ('fstring_content -> fstring_part','fstring_content',1,'p_fstring_content','interpreter.py',483),
  ('fstring_part -> STRING_CONTENT','fstring_part',1,'p_fstring_part','interpreter.py',490),
  ('fstring_part -> LBRACE expression RBRACE','fstring_part',3,'p_fstring_part','interpreter.py',491),
  ('logic_expr -> logic_expr OR_OP logic_term','logic_expr',3,'p_logic_expr','interpreter.py',498),
  ('logic_expr -> logic_term','logic_expr',1,'p_logic_expr','interpreter.py',499),
  ('logic_term -> logic_term AND_OP equality_expr','logic_term',3,'p_logic_term','interpreter.py',507),
  ('logic_term -> equality_expr','logic_term',1,'p_logic_term','interpreter.py',508),
  ('equality_expr -> relational_expr','equality_expr',1,'p_equality_expr','interpreter.py',516),
  ('equality_expr -> equality_expr EQ relational_expr','equality_expr',3,'p_equality_expr','interpreter.py',517),
  ('equality_expr -> equality_expr NEQ relational_expr','equality_expr',3,'p_equality_expr','interpreter.py',518),
  ('relational_expr -> additive_expr','relational_expr',1,'p_relational_expr','interpreter.py',525),
  ('relational_expr -> relational_expr LT additive_expr','relational_expr',3,'p_relational_expr','interpreter.py',526),
  ('relational_expr -> relational_expr GT additive_expr','relational_expr',3,'p_relational_expr','interpreter.py',527),
  ('relational_expr -> relational_expr LE additive_expr','relational_expr',3,'p_relational_expr','interpreter.py',528),
  ('relational_expr -> relational_expr GE additive_expr','relational_expr',3,'p_relational_expr','interpreter.py',529),
  ('additive_expr -> additive_expr PLUS term','additive_expr',3,'p_additive_expr','interpreter.py',536),
  ('additive_expr -> additive_expr MINUS term','additive_expr',3,'p_additive_expr','interpreter.py',537),
  ('additive_expr -> term','additive_expr',1,'p_additive_expr','interpreter.py',538),
  ('term -> term TIMES factor','term',3,'p_term','interpreter.py',546),
  ('term -> term DIVIDE factor','term',3,'p_term','interpreter.py',547),
  ('term -> term MOD factor','term',3,'p_term','interpreter.py',548),
  ('term -> factor','term',1,'p_term','interpreter.py',549),
  ('factor -> PLUS factor','factor',2,'p_factor','interpreter.py',557),
  ('factor -> MINUS factor','factor',2,'p_factor','interpreter.py',558),
  ('factor -> NOT factor','factor',2,'p_factor','interpreter.py',559),
  ('factor -> primary','factor',1,'p_factor','interpreter.py',560),
  ('primary -> atom','primary',1,'p_primary','interpreter.py',568),
  ('primary -> primary DOT IDENTIFIER','primary',3,'p_primary','interpreter.py',569),
  ('primary -> primary LPAREN arg_list RPAREN','primary',4,'p_primary','interpreter.py',570),
  ('primary -> primary LPAREN RPAREN','primary',3,'p_primary','interpreter.py',571),
  ('atom -> IDENTIFIER','atom',1,'p_atom','interpreter.py',582),
  ('atom -> NUMBER','atom',1,'p_atom','interpreter.py',583),
  ('atom -> STRING','atom',1,'p_atom','interpreter.py',584),
  ('atom -> TRUE','atom',1,'p_atom','interpreter.py',585),
  ('atom -> FALSE','atom',1,'p_atom','interpreter.py',586),
  ('atom -> LPAREN expression RPAREN','atom',3,'p_atom','interpreter.py',587),
  ('member_access -> DOT IDENTIFIER','member_access',2,'p_member_access','interpreter.py',614),
  ('member_access -> DOT IDENTIFIER LPAREN arg_list RPAREN','member_access',5,'p_member_access','interpreter.py',615),
  ('member_access -> DOT IDENTIFIER LPAREN RPAREN','member_access',4,'p_member_access','interpreter.py',616),
  ('wait_statement -> WAIT expression','wait_statement',2,'p_wait_statement','interpreter.py',631),
  ('function_call -> IDENTIFIER LPAREN arg_list RPAREN','function_call',4,'p_function_call','interpreter.py',635),
  ('function_call -> IDENTIFIER LPAREN RPAREN','function_call',3,'p_function_call','interpreter.py',636),
  ('function_call -> primary DOT IDENTIFIER LPAREN arg_list RPAREN','function_call',6,'p_function_call','interpreter.py',637),
  ('function_call -> primary DOT IDENTIFIER LPAREN RPAREN','function_call',5,'p_function_call','interpreter.py',638),
  ('arg_list -> expression','arg_list',1,'p_arg_list','interpreter.py',660),
  ('arg_list -> arg_list COMMA expression','arg_list',3,'p_arg_list','interpreter.py',661),
  ('arg_list -> empty','arg_list',1,'p_arg_list','interpreter.py',662),
  ('block -> LBRACE RBRACE','block',2,'p_block','interpreter.py',672),
  ('block -> LBRACE statement_list RBRACE','block',3,'p_block','interpreter.py',673),
  ('empty -> <empty>','empty',0,'p_empty','interpreter.py',680),
]
